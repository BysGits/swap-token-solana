...
describe("Getting event", () => {
  ...
  it("Getting events", async () => {
    
    // Get transaction from its signature
    const tx = await anchor.getProvider().connection.getTransaction("uXjqLMPTkfijhuDQ22N26wZxrQBRqxiPEQGYzvfeumbR1hu5a5isR4R4WLK6i6RMAW7ESJffmLyPVRycEbs97Hs", {
      commitment: "confirmed",
    });
    
    const eventParser = new EventParser(program.programId, new BorshCoder(idl));
